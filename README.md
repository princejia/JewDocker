...
- 🧾 销售与退货：销售流水、退货冲正、客单价统计；记录销售员，可按月份/销售员筛选统计提成
- 📝 报价管理：按客户建报价单，选产品→带入金额→打折报价，单条一键转为销售
- 🔨 加工管理：加工单登记，客户与待加工物品（产品/裸石）可搜索选择，记录加工要求与费用
- 🤝 借调管理：借出与归还记录
- 👥 客户管理：客户档案与历史往来
- 📈 财务报表：销售趋势图、库存价值、未结款汇总、借售追踪；利润明细拆解黄金的工费/附加费/金价三段利润，可导出 Excel
...
app/
  (auth)/login          登录页
  (dashboard)/          后台（仪表盘/产品/裸石/报价/销售/客户/报表/扫码/用户）
